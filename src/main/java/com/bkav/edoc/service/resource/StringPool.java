...
public class StringPool {
	...
	public static String GET_PENDINGS = "GetPendingDocumentIds";
	...
	public static String ENABLE_TEST = "edxml.context.test.enable";
	public static String ERROR_ACTION_CLASS = "com.bkav.edoc.service.center.ErrorProcess";
	public static String ERROR_ACTION_METHOD = "getReport";
	public static String ERROR_MESS = "redirect.error.message";
	public static String ENABLE_MEMCACHED = "edxml.context.memcached.enable";
	public static String ENABLE_SOLR = "edxml.context.solr.enable";
	public static String ORGANIZATION_DOMAIN = "OrganizationDomainByToken";
	public static String SYSTEM_TIME = "SystemTimeByNano";
	public static String CLIENT_ADDRESS = "ClientAddress";
	public static String IS_USING_TOKEN = "IsUsingToken";
	public static String DEFAULT_STRING = "";//"Undefined";
	public static String DEFAUlt_INTEGER = "0";
	public static String DEFAULT_DATE ="01/01/1900";
	public static String SEND_MESSAGE_KEY = "envelope_request";
	public static String SEND_ACTION ="SendMessage";
	public static String OUT_PHASE_NAME = "OperationOutPhase";
	public static String IN_PHASE_NAME = "edXMLIn";
	public static String ERROR_TYPE_REQUEST_MESSAGE = "Request khong hop le";
	public static String EDXML_ENVELOPE = "edxml_envelope";	
	
	public static String EDOC1_TOKEN = "Edoc1Token";
	...
	public static String ACTION_SEND_DOCUMENT = "SendDocument";
	public static String ACTION_CHECK_PERMISSION = "CheckPermission";
	public static String GET_MESSAGE_KEY = "envelope_reponse_success";
	...
	//TODO: Phan danh sach the de check trong ham getDocument
	 ...
	 /*Registry Area*/
	 public static String REGISTRY_TARGET_NAMESPACE = "http://com/bkav/edoc/registry/service/entity";
	 public static String REGISTRY_PREFIX = "";
	 public static String REGISTRY_QUERY_RESOURCE_REQ = "QueryResource";
	 public static String REGISTRY_TAG_ORGANIZATIONS = "Organizations";
	 public static String REGISTRY_TAG_ORGANIZATION = "Organization";
	 public static String REGISTRY_QUERY_RESOURCE_RES = "QueryResourceResponse";
	 
	 public static String REGISTRY_GET_CERT_INFO_REQ = "GetCertificateInfo";
	 public static String REGISTRY_GET_CERT_INFO_RES = "GetCertificateInfoResponse";
	 public static String REGISTRY_GET_CERT_INFO_SERIAL = "Serial";
	 
	 public static String REGISTRY_ACTION_QUERY_RESOURCE = "QueryResource";
	 public static String REGISTRY_ACTION_GET_CERT_INFO = "GetCertificateInfo";
	 public static String REGISTRY_ACTION_GET_TIMESTAMP = "GetTimestamp";
	 public static String REGISTRY_ACTION_GET_DOMAIN = "GetDomain";
	 
	 public static String REGISTRY_GET_TIMESTAMP_REQ = "GetTimestamp";
	 public static String REGISTRY_GET_TIMESTAMP_SIGNATURE_VALUE = "SignatureValue";
	 public static String REGISTRY_GET_TIMESTAMP_RES = "GetTimestampResponse";
	 
	 public static String REGISTRY_GET_DOMAIN_REQ = "GetDomain";
	 public static String REGISTRY_GET_DOMAIN_SERIAL= "Serial";
	 public static String REGISTRY_GET_DOMAIN_DOMAIN= "Domain";
	 public static String REGISTRY_GET_DOMAIN_RES = "GetDomainResponse";
